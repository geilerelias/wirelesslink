        ...
        <section style="height: 100vh">
            ...
            <div class="mt-12 fill-height">
                <p class="text-subtitle-1 ml-6">
                    ¿Deseas abrir el test en una ventana nueva?
                    <a class="text-decoration-none text-h2 text-decoration-none text-grey-darken-3 router-link-active
                       router-link-exact-active" href="https://wirelesslink.speedtestcustom.com/" target="_blank">
                        <svg style="height: 17px" viewBox="0 0 1137.5 134.2" xmlns="http://www.w3.org/2000/svg">
                            <title>
                                Speedtest logo
                            </title>
                            <path
