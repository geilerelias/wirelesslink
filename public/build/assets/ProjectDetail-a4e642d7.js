import{_ as P}from"./PageLayout-c21b3f17.js";import{K as S,r as f,j as T,s as B,k as r,o as s,c as d,w as a,b as t,a as h,u as n,h as E,t as I,f as _,F as y,i as b}from"./app-664144cd.js";import $ from"./Gallery-7f9f4b10.js";import{_ as F}from"./SpinnerComponent-5991fdf7.js";import{L as H}from"./LoadingComponent-87a0f1ed.js";import"./logo-cc70ed57.js";import"./_plugin-vue_export-helper-c27b6911.js";import"./aos-1b9c4dde.js";import"./lazy-bg-1-41b88f2b.js";const N={class:"text-md-left"},V=["data-aos","innerHTML"],A={class:"border-top"},G={key:0},Y={__name:"ProjectDetail",setup(z){const{props:w}=S(),c=f(w.project),{mobile:x}=T();let i=[],p=f(!0);const u=f([]);B(()=>{k()});const k=async()=>{try{const o=await axios.get("/get/list/projects");console.log(o.data),u.value=await o.data.find(e=>e.folder===c.value),console.log(u.value);const m=u.value.sub;p.value=!1,m.length>0?i=m.map(e=>({url:`/get/img/${c.value}/${e.url}`,width:e.width,height:e.height})):console.log("nada")}catch(o){console.error("Error al obtener la lista de proyectos",o)}},j=o=>{switch(o){case"hidropaneles":return`
